...
class RedirectionTool(UniqueObject, SimpleItem):
    ...
    @deprecate(
        "The addRedirect method of the RedirectionTool has been "
    ...
    @deprecate(
        "The removeRedirect method of the RedirectionTool has been "
        "deprecated. Use the IRedirectionStorage utility from "
        "plone.app.redirector instead."
    )
    ...
    @deprecate(
        "The getRedirectObject method of the RedirectionTool has been "
    ...
    @deprecate(
        "The getRedirect method of the RedirectionTool has been "
        "deprecated. Use the IRedirectionStorage utility from "
        "plone.app.redirector instead."
    )
    ...
    @deprecate(
        "The getRedirectsTo method of the RedirectionTool has been "
        "deprecated. Use the IRedirectionStorage utility from "
        "plone.app.redirector instead."
    )
    ...
    @deprecate(
        "The extractReference method of the RedirectionTool has been "
        "deprecated. There is no replacement, since it was never "
        "public."
    )
    def extractReference(self, source):
        ...
        reftool = getToolByName(
            self, "reference_catalog", getToolByName(self, "archetype_tool", None)
        )
    ...
    @deprecate(
        "The checkPermission method of the RedirectionTool has been "
        "deprecated. There is no replacement, since it was never "
        "public."
    )
        ...
        if base_hasattr(self, "_redirectionmap"):
            ...
            for key in redirmap:
                try:
                    ...
                    logger.warning(
                        "The destination '%s' for '%s' could not be "
